...
const Income = () => {
  ...
  const generateMonthOptions = () => {
    ...
    for (let i = 24; i >= 0; i--) {
      ...
      options.push({
        value: monthValue,
        label: formatters.dateMonthYear(date)
      });
    }
  ...
  return <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      {/* Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <div className="bg-white dark:bg-gray-800 p-2 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 py-0 px-px my-0 mx-0">
            <Select value={selectedMonth} onValueChange={setSelectedMonth}>
              <SelectTrigger className="w-full sm:w-48 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-700 hover:from-blue-100 hover:to-blue-150 dark:hover:from-blue-800/30 dark:hover:to-blue-700/30 transition-all duration-200">
          ...
          <Button onClick={() => setShowAddIncome(!showAddIncome)} className="w-full sm:w-auto py-0">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                ...
                <Input id="description" placeholder="Ex: Salário, Freelance..." value={incomeForm.description} onChange={e => setIncomeForm({
              ...incomeForm,
              ...
              <div>
                ...
                <Input id="amount" type="number" step="0.01" placeholder="0,00" value={incomeForm.amount} onChange={e => setIncomeForm({
              ...incomeForm,
              ...
              <div>
                ...
                <Input id="date" type="date" value={incomeForm.date} onChange={e => setIncomeForm({
              ...incomeForm,
              date: e.target.value
            })} />
              </div>
              <div>
                ...
                <Select value={incomeForm.type} onValueChange={(value: 'salary' | 'bonus' | 'investment' | 'other') => setIncomeForm({
              ...incomeForm,
              type: value
            })}>
                  <SelectTrigger>
              ...
              <div>
                ...
                {categoriesLoading ? <div className="h-10 bg-gray-200 rounded animate-pulse" /> : <CategorySelector categories={incomeCategories} value={incomeForm.category_id} onValueChange={value => setIncomeForm({
              ...incomeForm,
              category_id: value
            ...
            <div className="flex items-center space-x-2">
              <Switch id="recurring" checked={incomeForm.is_recurring} onCheckedChange={checked => setIncomeForm({
            ...incomeForm,
            ...
            {incomeForm.is_recurring && <div className="w-full sm:w-48">
                <Label htmlFor="recurrence">Repetir por quantos meses</Label>
                <Input id="recurrence" type="number" min="1" max="60" placeholder="Ex: 12" value={incomeForm.recurrence_months} onChange={e => setIncomeForm({
            ...incomeForm,
      ...
      <Card>
        ...
        <CardContent>
          {filteredIncomes.length === 0 ? <div className="text-center py-8 text-gray-500 dark:text-gray-400">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredIncomes.map(income => <IntegratedIncomeRow key={`${income.id}-${income.occurrenceIndex || 0}`} income={income} onUpdateOccurrence={handleUpdateOccurrence} onDeleteIncome={handleDeleteIncome} onEditIncome={handleEditIncome} />)}
                </tbody>
              </table>
            </div>}
        </CardContent>
