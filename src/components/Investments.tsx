...
import { Plus, TrendingUp, TrendingDown, DollarSign, Percent, RefreshCw, Clock, Edit } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { useSupabaseTables } from '@/hooks/useSupabaseTables';
import { useFormatters } from '@/hooks/useFormatters';
import { useMultipleStockQuotes, useStockQuote } from '@/hooks/useMarketData';
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Button
                          ...
                          className="w-full"
                        >
                          <RefreshCw className={`h-4 w-4 mr-2 ${updatingIndividual === investment.id ? 'animate-spin' : ''}`} />
                          {updatingIndividual === investment.id ? 'Atualizando...' : 'Atualizar'}
                        </Button>
                        <CrudActions
                          item={investment}
